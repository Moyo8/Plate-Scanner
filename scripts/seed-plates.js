...
const Plate = require('../backend/models/Plate');
...
const samplePlates = [
  ...
  carInfo: { model: 'Chevrolet, Impala 2004', color: 'Black', category: 'Private', expires: new Date('2025-08-01') },
    status: 'Expired',
  ...
  carInfo: { model: 'Toyota, Corolla 2023', color: 'Blue', category: 'Public', expires: new Date('2029-03-21') },
    status: 'Valid',
    registeredBy: 'Admin-01'
  },
  {
  ...
  carInfo: { model: 'Mitsubishi, Truck 2019', color: 'Yellow', category: 'Private', expires: new Date('2029-09-30') },
    status: 'Flagged',
  ...
  carInfo: { model: 'Hyundai, Santa Cruz', color: 'Blue', category: 'Private', expires: new Date('2025-01-19') },
    status: 'Expired',
    registeredBy: 'Admin-01'
  },
  {
  ...
  carInfo: { model: 'BMW, iX1', color: 'Blue', category: 'Private', expires: new Date('2031-06-07') },
    status: 'Valid',
  ...
  carInfo: { model: 'Audi, e-tron GT', color: 'Blue', category: 'Public', expires: new Date('2031-01-01') },
    status: 'Valid',
  ...
  carInfo: { model: 'Tesla, Cybertruck 2024', color: 'Black', category: 'Private', expires: new Date('2034-06-07') },
    status: 'Valid',
    registeredBy: 'Admin-03'
  },
  {
  ...
  carInfo: { model: 'Mercedes-Benz, GLE-SUV 2025', color: 'Blue', category: 'Private', expires: new Date('2026-08-01') },
    status: 'Valid',
    registeredBy: 'Admin-03'
  },
  {
  ...
  carInfo: { model: 'Honda, Accord 2011', color: 'Silver', category: 'Private', expires: new Date('2031-04-07') },
    status: 'Valid',
    registeredBy: 'Admin-01'
  },
  {
  ...
  carInfo: { model: 'Kia, Rio 2014', color: 'Silver', category: 'Private', expires: new Date('2031-02-07') },
    status: 'Flagged',
    registeredBy: 'Admin-01'
  }
];
